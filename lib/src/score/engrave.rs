...
//!
//! Narrating a walk is not this pipeline's job either: that belongs to
//! [`crate::musicxml::visitors::logging_visitor`], which runs on the validation
//! walk and reports through the context rather than through here.
