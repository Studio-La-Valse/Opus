...
/// Places the elements of a measured visual score that sit inside the
/// containers [`PageArranger`](crate::score::visual::arranger::PageArranger)
/// has placed: chords, notes, rests, the clefs and signatures of a measure, and
/// the group symbols and names.
///
...
/// because sizing is settled by the time it runs. Not itself a
/// [`ScoreArranger`](crate::score::visual::arranger::ScoreArranger): the passes
/// that are -- [`ContentArranger`](crate::score::visual::arranger::ContentArranger),
